...
class NPM(Command):
    ...
    targets = [
        join(here, "msheet", "static", "extension.js"),
        join(here, "msheet", "static", "index.js"),
    ]
...
data_files = package_files("msheet/static")
...
setup_args = {
    ...
    "data_files": [
        ("share/jupyter/nbextensions/msheet", data_files),
    ],
